...
import { getCurrentLocale, translate } from '../../shared/i18n.js';
import type { ChildrenProp, ToastContextValue, ToastVariant } from './types';
...
export function ToastProvider({ children }: ChildrenProp) {
  ...
  const showToast = useCallback<ToastContextValue['showToast']>(({ title, description, variant = 'info', duration = 4200 }) => {
