...
const messages = {
  ...
  'radar.enrichBody': 'Review release-level minimum prices for your Wantlist and preserve pending, failed, and no-price states so retries stay truthful.',
...
describe('Radar page', () => {
  beforeEach(() => {
    ...
    getRadarStatus.mockResolvedValue({
      ...
      pending: 2,
      progressPercent: 0,
      message: 'Radar is ready to review Wantlist prices.',
      startedAt: null,
      finishedAt: null,
      isRunning: false,
      isTerminal: false,
