...
const RADAR_KEYS = [
  ...
  'radar.updating',
  'radar.updateError',
  'radar.updateStatusError',
  'radar.updateTitle',
  'radar.updateBody',
  'radar.updatePhase.idle',
  'radar.updatePhase.syncing',
  'radar.updatePhase.reviewing_prices',
  'radar.updatePhase.completed',
  'radar.updatePhase.completed_with_issues',
  'radar.updatePhase.failed',
  'radar.updatePhase.stopped',
  'radar.updateStop',
  'radar.updateStatus',
  'radar.updateCurrent',
  'radar.updateTotal',
